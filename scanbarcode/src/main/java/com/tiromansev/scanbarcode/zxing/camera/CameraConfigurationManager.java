...
import com.tiromansev.scanbarcode.zxing.camera.open.CameraFacing;
import com.tiromansev.scanbarcode.zxing.camera.open.OpenCamera;
...
final class CameraConfigurationManager {
  ...
  void setDesiredCameraParameters(OpenCamera camera, boolean safeMode) {
    ...
    CameraConfigurationUtils.setFocus(
        ...
        prefs.getBoolean(PreferencesFragment.KEY_DISABLE_CONTINUOUS_FOCUS, true),
        safeMode);
